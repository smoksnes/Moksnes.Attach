...
namespace Moksnes.Attach
{
    ...
    internal sealed class AttachIISCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("9f80fb75-f5c4-4c67-b6ad-69e7551fa970");
        ...
        private AttachIISCommand(Package package)
        {
            if (package == null)
            {
        ...
        {
            Instance = new AttachIISCommand(package);
        }
